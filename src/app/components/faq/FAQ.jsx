    ...
    <>
      <section className="bg-primary py-70 px-3 md:px-4 lg:px-5">
        <div className="container mx-auto">
          ...
          <div className="mt-50">
            <div className="faq-wrapper flex flex-col gap-6">
              {faqData.map((item) => (
                <div key={item.id} className="py-6 border-b border-[#fff3]">
                  <button
                    onClick={() => toggleAccordion(item.id)}
                    className="flex w-full cursor-pointer items-center justify-between outline-none ps-7.5 pb-6 pe-20"
                  >
                  ...
                  <AnimatePresence initial={false}>
                    {activeId === item.id && (
                      ...
                      >
                        <p className="p-7.5 pt-0 text-white! fs-18">
                          {item.answer}
                        </p>
                      </motion.div>
                    )}
          ...
          <div className="flex justify-center mt-27.5">
            <div className="flex flex-col justify-center">
              ...
              <img
                ...
                alt=""
                className="self-end -mt-5 -mb-12.5 translate-x-full"
              />
